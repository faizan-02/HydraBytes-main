        ...
        html: `
          <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;background:#0a0a12;color:#f0f0f5;border-radius:12px;overflow:hidden;">
            ...
            <div style="padding:40px 32px;">
              ...
              <div style="background:rgba(0,180,216,0.08);border:1px solid rgba(0,180,216,0.2);border-radius:12px;padding:24px;margin-bottom:28px;">
                ...
                <table style="width:100%;border-collapse:collapse;">
                  <tr>
                    <td style="padding:10px 0;color:#6c6c85;font-size:14px;border-bottom:1px solid rgba(0,180,216,0.12);">Service</td>
                    <td style="padding:10px 0;color:#f0f0f5;font-size:14px;font-weight:600;text-align:right;border-bottom:1px solid rgba(0,180,216,0.12);">${safeServiceLabel}</td>
                  </tr>
                  <tr>
              ...
              ${projectId
                ? `<div style="background:rgba(99,102,241,0.08);border:1px solid rgba(99,102,241,0.25);border-radius:12px;padding:20px;margin-bottom:28px;text-align:center;">
                    ...
                    <a href="${BASE_URL}/dashboard" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#1a6b7a,#00b4d8);color:#fff;text-decoration:none;border-radius:999px;font-weight:700;font-size:15px;">View Dashboard →</a>
                  </div>`
                : `<div style="background:rgba(0,180,216,0.08);border:1px solid rgba(0,180,216,0.25);border-radius:12px;padding:24px;margin-bottom:28px;">
                    ...
                    <a href="${BASE_URL}/auth/register?email=${encodeURIComponent(email)}" style="display:inline-block;padding:14px 32px;background:linear-gradient(135deg,#1a6b7a,#00b4d8);color:#fff;text-decoration:none;border-radius:999px;font-weight:700;font-size:15px;">Create Free Account</a>
                  </div>`
              }
