...
const PAYMENT_METHODS = [
  {
    ...
    fields: [
      ...
      { label: 'Account Name',   value: 'HydraBytes (Update This)' },
    ],
  ...
  },
  {
    ...
    fields: [
      { label: 'Mobile Account', value: '0300-0000000' },
      { label: 'Account Name',   value: 'HydraBytes (Update This)' },
    ],
  ...
  },
  {
    ...
    fields: [
      { label: 'NayaPay ID / Phone', value: '0300-0000000' },
      { label: 'Account Name',       value: 'HydraBytes (Update This)' },
    ],
  ...
  },
  {
    ...
    fields: [
      { label: 'Bank Name',    value: 'HBL / Meezan / (Update This)' },
      { label: 'Account No.', value: 'XXXXXXXXXXXXXXXX' },
      { label: 'IBAN',        value: 'PK00XXXX0000000000000000' },
      { label: 'Account Name', value: 'HydraBytes (Update This)' },
    ],
