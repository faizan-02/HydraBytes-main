...
const contactInfo = [
  ...
  { icon: <MapPin size={20} strokeWidth={1.5} />, label: 'Office', value: 'Bahria Innovation Center (BIC), Bahria University Islamabad', href: 'https://maps.google.com/?q=Bahria+Innovation+Center+Bahria+University+Islamabad+Pakistan' },
